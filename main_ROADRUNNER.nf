...
combine_wise(create_wise_files.out[0].map{ id, txt -> txt}.flatten().toList(), create_wise_files.out[0].map{ id, txt -> txt}.flatten().toList()create_wise_files.out[0].map{ id, txt -> txt}.first(),run)
